    ...
    <div className="w-full h-screen flex items-center gap-5 px-20">
      ...
      <div className="cardcontainer w-1/2 h-[50vh] flex gap-5">
        ...
        <img className='w-32' src="https://ochi.design/wp-content/uploads/2022/04/logo003.png" alt="logo" />
            <button className='absolute px-5 py-1 border-[1.5px] border-zinc-100 rounded-full left-10 bottom-10 text-zinc-100 font-[550] font-["Neue_Montreal"] uppercase'>business bootcamp</button>
        </div>
      </div>
    </div>
  );
